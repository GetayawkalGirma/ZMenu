      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-32 h-32 md:h-auto bg-gray-50 flex-shrink-0 relative overflow-hidden">
          {imageSrc ? (
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://placehold.co/600x400?text=No+Item+Image";
              }}
            />
          ) : (
            <div className="w-full h-full flex flex-col items-center justify-center text-gray-400 opacity-40">
              ...
              <span className="text-[8px] font-bold uppercase tracking-tighter">No Photo</span>
            </div>
          )}
        </div>
        ...
        <div className="flex-1 p-4 flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div className="min-w-0">
              ...
              <div className="mt-1 flex items-center space-x-2">
                ...
                {meal.categoryId && (
                  <Badge variant="secondary" className="bg-blue-50 text-blue-700 border-blue-100 hover:bg-blue-100 py-0 text-[10px]">
                    {meal.categoryId}
                  </Badge>
                )}
                <Badge variant="outline" className="text-gray-500 border-gray-200 py-0 text-[10px]">
          ...
          <div className="mt-2 text-sm text-gray-600 line-clamp-1 italic">
            {meal.restDescription || meal.description || "No description provided."}
          </div>
          ...
          <div className="mt-3 flex items-center justify-between border-t border-gray-50 pt-2">
            <div className="flex flex-wrap gap-1">
              ...
              {meal.tags && meal.tags.length > 3 && (
                <span className="text-[10px] text-gray-300">+{meal.tags.length - 3}</span>
              )}
            </div>
